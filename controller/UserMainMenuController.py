import pymysql
from model.Logowanie import *
from controller.LogowanieController import *

class UserMainMenuController:
    def __init__(self):
        print('*** Pracujesz w UserMainMenuController Constructor ***')

    def UserMainMenu(self):
        print('***** Witaj użytszkodniku *****')
        decyzja = input(
            "***** Co chcesz zrobić:\n[1]\t\t- wypisz info o swoim koncie,\n[2]\t\t- zrób coś z teczkami uczniów,\n[3]\t\t- dodaj jakieś pismo (eKancelaria, JRWA),\n[Ex]it\t- wyjście z programu.\n").upper()
        if (decyzja == '1'):
            # self.userManagement()
            print("\nNie!\n")
            pass
